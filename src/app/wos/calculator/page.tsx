    ...
    <div className="min-h-screen bg-gray-900 text-white p-8">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-center border-b border-gray-700 mb-8">
          <button
            className={`px-6 py-3 font-bold text-lg focus:outline-none ${activeTab === 'soldier' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-500'}`}
            onClick={() => setActiveTab('soldier')}
          >
            병사 비율 계산기
          </button>
          <button
            className={`px-6 py-3 font-bold text-lg focus:outline-none ${activeTab === 'time' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-500'}`}
